...
<font size="2.5px">
<form name="form2" action="PublishArticle" method="post">
<font size="2.5px" color=red><b>博文标题：</b></font>
<input name="title" type="text" ><br><br>
<textarea name="cont" style="display:none;"></textarea><br>
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="389">
    	<input name="submit" type="submit" value="确认发表博文" onclick="return checkInput()" />
...
beginneon()
	  ...
	  <br />
  Copyright © 2010 <a href="http://www.xulongkang.wanye68.com" target="_blank" title="浙江农林大学">浙江农林大学</a> Corporation, All Rights Reserved </span><span class="STYLE5"><br />
      </span>
