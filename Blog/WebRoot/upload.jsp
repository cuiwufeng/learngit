...
<table width="95%" height="70%" align="center" style="border: 1px solid #C6B5AD;" bgcolor="#F4EFEB">
  <tr>
    <td height="421">
	<div align="center">
	  <p class="STYLE11">请选择您的照片（格式：*.gif，*.jpg），然后单击确认提交按钮上传到服务器。如果不想上传请直接点击返回首页！</p>
	  <%
  		String picname=request.getParameter("username");
  	%>
	<form name="uploadFrm" action="up.jsp" method="post" enctype="multipart/form-data">
	  <table width="375" border="0">
        <tr>
          <td width="87"><span class="STYLE12">图片文件：</span></td>
          <td width="278"><input name="file" type="file" /></td>
        </tr>
        <tr>
          <td><span class="STYLE12"></span></td>
          <td><span class="STYLE12">
            <input type="hidden" name="username" value="<%=picname %>" />
            <input name="submit" type="submit" value="确认提交" /> 
            &nbsp;<a href="index.jsp">返回首页</a></span></td>
        </tr>
      </table>
	 </form>
	</div>
...
<div align="center">
      ...
      <u><br />
      博客</u></a>&nbsp;&nbsp;&nbsp;<a href="mailto:1489897665@qq.com"><u>联系作者</u></a>&nbsp;&nbsp;&nbsp;<a href="register.jsp"><u>会员注册</u></a><a href="register.jsp"></a> &nbsp;&nbsp;
