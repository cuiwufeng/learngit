...
<table width="95%" height="70%" align="center" style="border: 1px solid #C6B5AD;" bgcolor="#F4EFEB">
  <tr>
    ...
    <form action="alertUser" method="post" name="form2"> 
	
	 <p class="STYLE13"><span class="STYLE14">请输入用户名、原始密码以及新密码</span>：</p>
	  <table width="372" border="0">
        <tr>
          <td width="73"><span class="STYLE11">用户名：</span></td>
          <td width="305"><span class="STYLE11">
            <input name="username" type="text" id="username" size="12" maxlength="12" />
          </span></td>
        </tr>
        <tr>
          <td><span class="STYLE11">原始密码：</span></td>
          <td><span class="STYLE11">
              <input name="password" type="password" id="password" size="12" maxlength="12" />
          </span></td>
        </tr>
        <tr>
          <td><span class="STYLE11">新密码：</span></td>
          <td><span class="STYLE11">
              <input name="newpassword" type="password" id="newpassword" size="12" maxlength="12" onblur="checkEqual()"/>&nbsp;&nbsp;<font color=red size="2"><span id="disp1"></span></font></span>
		 </td>
        </tr>
        <tr>
          <td><span class="STYLE11">确认密码：</span></td>
          <td><input name="confirmpassword" type="password" size="12" maxlength="12" /></td>
        </tr>
        <tr>
          <td height="33"><span class="STYLE11"></span></td>
          <td><span class="STYLE11"></span></td>
        </tr>
        <tr>
          <td><span class="STYLE11"></span></td>
          <td><span class="STYLE11">
            <input type="submit" name="submit" value="确认修改" onclick="return checkdatas()" />
            &nbsp;
